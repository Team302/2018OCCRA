...
#pragma config(Motor,  port5,           leftShooterMotor, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port6,           rightShooterMotor, tmotorServoContinuousRotation, openLoop)
...
#define REVERSE_SHOOTER						 vexRT[Btn8UXmtr2]

//#define BELT_INTAKE								 vexRT[Ch3Xmtr2]
#define INTAKE_MOTOR							 vexRT[Ch3Xmtr2]
#define SHOOTER_STOP							 vexRT[Btn8LXmtr2]
...
task main ()
{
	...
	{/*
		...
		*/
		if(-0.1 < INTAKE_MOTOR && INTAKE_MOTOR < 0.1)
		{
			motor[intakeMotor] = 0.0;
		}
	else{
